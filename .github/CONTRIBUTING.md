...
We would love for you to contribute to coco and help make it even better than it is
...
You can file new issues by filling out our [new issue form](https://github.com/inherd/coco/issues/new).


### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/inherd/coco/pulls) for an open or closed PR
...
* Run the full coco test suite, and ensure that all tests pass.
...
* In GitHub, send a pull request to `coco:master`.
* If we suggest changes then:
  * Make the required updates.
  * Re-run the coco test suites to ensure tests are still passing.
...
we use the git commit messages to **generate the coco change log**.
...
Samples: (even more [samples](https://github.com/inherd/coco/commits/master))
